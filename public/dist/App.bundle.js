...
function ajaxHeart(event) {
  ...
  _axios2.default.post(this.action) // Form action
  .then(function (res) {
...
var _dompurify = __webpack_require__(9);
...
function loadPlaces(map) {
  ...
  _axios2.default.get('/api/v1/stores/near/?lat=' + lat + '&lng=' + lng).then(function (res) {
    ...
    var infoWindow = new google.maps.InfoWindow(); // Popup with info
    ...
    markers.forEach(function (marker) {
      return marker.addListener('click', function () {
        ...
        infoWindow.setContent(_dompurify2.default.sanitize(html));
...
} // Kind of fetch, has sane defaults, can cancel requests
...
function typeAhead(searchBox) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/v1/search?q=' + this.value).then(function (res) {
      if (res.data.length) {
        searchResults.innerHTML = _dompurify2.default.sanitize(createSearchResultsHTML(res.data));
        return;
      }
  ...
  searchInput.on('keyup', function (event) {
    ...
    var next = void 0; // Next selected item
